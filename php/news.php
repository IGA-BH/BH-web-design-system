...
<section class="govbh-section" aria-labelledby="news-section-title">
    ...
    <div class="container">
                                    ...
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div
                                            ...
                                            <select class="with-search" data-placeholder-search="Search Category"
                                                ...
                                                data-select-all-text="Select All" data-unselect-all-text="Unselect All"
                                                data-selected-option-text="selected" multiple id="select-003" aria-label="Select Categories">
        ...
        <div role="region" aria-label="Featured News">
            <a href="news-detail-page.html" class="govbh-newscard" aria-describedby="featured-news-title" id="featured-news-title">
                ...
                <div class="govbh-newscard__content">
                    <div class="govbh-newscard__content-head">
                        ...
                        <h2 class="govbh-newscard__title">Lorem ipsum dolor sit amet, consectetur
        ...
        <!-- List Grid Starts -->
        <div role="region" aria-label="All news">
                ...
                <div class="col-xxl-4 col-xl-5 col-lg-5 col-md-8 col-sm-12 col-12">
                    <div class="d-flex justify-content-end gap-2">
                        ...
                        <div class="govbh-view-toggle d-md-flex d-sm-none d-none" role="group"
                            ...
                            <a href="news.html" class="govbh-view-toggle__list govbh-view-toggle--active" data-view="grid" aria-label="Now you are in grid view" data-tooltip="tooltip" title="Now you are in grid view" aria-pressed="true" role="button"><i class="ph ph-squares-four" aria-hidden="true"></i></a>
                            <a href="news-list-view.html" class="govbh-view-toggle__list" data-view="list" aria-label="Switch to list view" data-tooltip="tooltip" title="Switch to list view" role="button"><i class="ph ph-list-bullets" aria-hidden="true"></i></a>
                        </div>
                        <!-- View Toggle Ends -->
                        ...
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-1" class="govbh-card__title"><a href="news-detail-page.html">Lorem ipsum
                    ...
                    <article role="region" aria-labelledby="news-title-2" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-2" class="govbh-card__title"><a href="news-detail-page.html">Maecenas
                                        ultricies sagittis mi varius ullamcorper</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                            <div class="govbh-card__foot-button">
                    ...
                    <article role="region" aria-labelledby="news-title-3" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-3" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                    ...
                    <article role="region" aria-labelledby="news-title-4" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-4" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                    ...
                    <article role="region" aria-labelledby="news-title-5" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-5" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                    ...
                    <article role="region" aria-labelledby="news-title-6" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-6" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                    ...
                    <article role="region" aria-labelledby="news-title-7" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-7" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                    ...
                    <article role="region" aria-labelledby="news-title-8" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-8" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
                    ...
                    <article role="region" aria-labelledby="news-title-9" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head p-0">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    29 May, 2025</div>
                                <h3 id="news-title-9" class="govbh-card__title"><a href="news-detail-page.html">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                            </div>
                        </div>
                        <div class="govbh-card__foot pe-none">
