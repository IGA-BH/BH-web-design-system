...
?>
    ...
    <!-- Fullwidth Hero Banner Slider Starts -->
    <section class="govbh-fullwidthslider bg--brand p-0" role="banner" aria-labelledby="hero-banner-title">
        <h1 id="hero-banner-title" class="visually-hidden bg--brand">Bahrain Government Guidlines Design System</h1>
        <div class="swiper govbh-fullwidthslider__swiper" aria-roledescription="carousel" role="group" aria-label="Hero Slider">
            <div class="swiper-wrapper">
                <div class="swiper-slide bg--brand h-auto" tabindex="0" data-swiper-autoplay="25000">
                    <div class="govbh-fullwidthslider__wrapper">
                        <!-- Video Starts -->
                        <div class="govbh-fullwidthslider__video active" data-swiper-parallax-opacity="0" data-swiper-parallax-scale="1.05">
                            <!-- Local Video Starts -->
                            <div class="govbh-fullwidthslider__video-local">
                                <video loop muted id="myVideo" playsinline class="video" preload="none">
                            ...
                            <!-- <div id="ytbg" class="video" data-vbg-autoplay="true" data-vbg-mobile="true"
                                    ...
                                    data-vbg="https://www.youtube.com/watch?v=Qp0_6AcGmCg"></div> -->
                            <!-- Youtube Video Ends -->
                            <!-- BG Image -->
                            <div class="govbh-fullwidthslider__img">
                                <picture>
                                    <source media="(min-width: 1200px)" srcset="../images/banner-001.webp"><!--1600*750 Default image-->
                                    ...
                                    <img src="../images/barhain-mobile.webp" height="480" width="1600" alt="A Legacy of Survey and Land Registration Excellence2"><!--767*320-->
                                </picture>
                            </div>
                        </div>
                        <!-- Video Ends -->
                        <!-- Content Section Starts -->
                        <div class="govbh-fullwidthslider__content theme--dark">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xxl-5 col-xl-6 col-lg-6 col-md-8 col-sm-12 col-12">
                                        <div class="govbh-fullwidthslider__title" data-swiper-parallax-x="-10%">
                                        ...
                                        <div data-swiper-parallax-x="-20%" class="d-flex align-items-center gap-3 flex-wrap">
                                            <a href="news-detail-page.html" class="govbh-btn govbh-btn--outline theme--dark">Read More <i class="ph ph-arrow-right" aria-hidden="true"></i></a>
                                            <!--  Play/Pause button -->
                                            <a href="#" class="govbh-fullwidthslider__playpause pause" role="button" aria-label="Click here to play video.">
                                                <i class="ph ph-pause icon--pause" aria-hidden="true"></i><i class="ph ph-play icon--play" aria-hidden="true"></i>
                                            </a>
                                        </div>
                                    </div>
                                    <div class="col-xxl-7 col-xl-6 col-lg-6 col-md-4 col-sm-12 col-12"></div>
                                </div>
                            </div>
                        </div>
                        <!-- Transcript Starts -->
                ...
                <div class="swiper-slide bg--brand h-auto" tabindex="0">
                    <div class="govbh-fullwidthslider__wrapper">
                        <!-- BG Image -->
                        <div class="govbh-fullwidthslider__img" data-swiper-parallax-opacity="0" data-swiper-parallax-scale="1.05">
                            <picture>
                                <source media="(min-width: 1200px)" srcset="../images/banner-002.webp"><!--1600*750 Default image-->
                                <source media="(min-width: 992px)" srcset="../images/banner-002.webp"><!--1199*500-->
                                <source media="(min-width: 768px)" srcset="../images/banner-002.webp"> <!--991*413-->
                                <img loading="lazy" src="../images/banner-mobile-1.webp" height="750" width="1600" alt="Ambitious Initiatives for Sustainable Development"><!--767*320-->
                            </picture>
                        </div>
                        <!-- Content Section Starts -->
                        <div class="govbh-fullwidthslider__content theme--dark">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div data-swiper-parallax-x="-20%" class="d-flex align-items-center flex-wrap gap-3">
                                            <a href="projects-detail.html" class="govbh-btn govbh-btn--outline theme--dark">Read More <i class="ph ph-arrow-right" aria-hidden="true"></i></a>
                                        </div>
                                    </div>
            ...
            <div class="govbh-fullwidthslider__swiper-pagination govbh-theme__pagination govbh-align-center govbh-align-bottom" role="group" tabindex="0" aria-label="Slider Controls"></div>
        </div>
    </section>
    <!-- Fullwidth Hero Banner Slider Ends -->
             ...
             <div class="row g-lg-4 g-md-3 g-3">
                <div class="col-12">
                    ...
                    <div class="govbh-content-block">
                        ...
                        <a href="about.html" aria-label="Read More: About the ministry" class="govbh-btn govbh-btn--outline mt-2">Read More <i class="ph ph-arrow-right" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="govbh-section bg--darkmode-primary" aria-labelledby="section-title-02">
        <div class="container">
            <h2 id="section-title-02">We Care About You</h2>
