        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">Legislations</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="legislations-page-title">
    <div class="container">
        ...
        <form action="#" autocomplete="on" class="govbh-search-card bg--grey mb-lg-5 mb-md-4 mb-4">
            <div class="govbh-search-card__title govbh-fs-h5 text--brand">Find a Legislation</div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div
                                            ...
                                            <select class="with-search" data-placeholder-search="Search a Legislation"
                                                data-placeholder="Select Legislation Type" data-columns="1"
                                                data-select-all="yes" data-select-all-text="Select All"
                                                data-unselect-all-text="Unselect All" data-selected-option-text=" selected"
                                            ...
                                            <label for="select-002">Legislation Type</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div
        ...
        <!-- List Grid Starts -->
        <div role="region" aria-label="All Legislations">
            <!-- Title and Sort by Starts -->
            <div class="row align-items-center g-3 mb-4">
                <div class="col-xxl-8 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
                    <h2 id="legislations-page-title" class="m-0">All Legislations</h2><!-- id comes from section aria-labelledby -->
                </div>
                    ...
                    <article role="region" aria-labelledby="legislation-title-1" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-1" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on Regulating the Work of Energy Efficiency Specialised Companies">Resolution
                                    on Regulating the Work of Energy Efficiency Specialised Companies</a></h3>
                            ...
                            <div class="govbh-card__paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                Quisque pulvinar sem at urna dapibus.</div>
                        </div>
                        <div class="govbh-card__foot">
                            <div class="govbh-btn govbh-btn--withoutline govbh-btn--medium">Read Full Article <i
                                    class="ph ph-arrow-right" aria-hidden="true"></i></div>
                            <div class="govbh-card-bg-icon"><img src="../images/utilities/laws-icon.svg"
                                    alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque pulvinar sem at urna dapibus.">
                            </div>
                        </div>
                    </article>
                </div>
                    ...
                    <article role="region" aria-labelledby="legislation-title-2" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-2" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on Adopting Thermal Insulation Regulations for Buildings and Facilities">Resolution
                                    on Adopting Thermal Insulation Regulations for Buildings and Facilities</a></h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 May, 2022</div>
                            </div>
                            <div class="govbh-card__paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <article role="region" aria-labelledby="legislation-title-3" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-3" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on Electricity and Water Consumption Tariffs">Resolution
                                    on Electricity and Water Consumption Tariffs</a></h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 May, 2022</div>
                            </div>
                            <div class="govbh-card__paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <article role="region" aria-labelledby="legislation-title-4" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-4" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on Adopting Regulations for Non-Directional Household Lighting">Resolution
                                    on Adopting Regulations for Non-Directional Household Lighting</a></h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 May, 2022</div>
                                <div><i class="ph ph-globe" aria-hidden="true"></i> Arabic only</div>
                            </div>
                    ...
                    <article role="region" aria-labelledby="legislation-title-5" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-5" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on Issuing the Plumbing Work Regulation">Resolution
                                    on Issuing the Plumbing Work Regulation</a></h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 May, 2022</div>
                            </div>
                            <div class="govbh-card__paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    ...
                    <article role="region" aria-labelledby="legislation-title-6" class="govbh-card govbh-card--card-file">
                        <div class="govbh-card__head">
                            <h3 id="legislation-title-6" class="govbh-card__title"><a href="legislations-detail.html"
                                    aria-label="Legislation: Resolution on the Electrical Installations System">Resolution
                                    on the Electrical Installations System</a></h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 May, 2022</div>
                            </div>
                            <div class="govbh-card__paragraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
