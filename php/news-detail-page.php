...
?>
            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li><a href="#" aria-label="Go to news">News</a></li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">SLRB organizes a discussion forum to facilitate all procedures, transactions, and to support the electronic transformation of services</li>
                    </ul>
                </nav>
    ...
    <!-- News Details Article Starts -->
    <article class="govbh-section" role="region" aria-labelledby="news-section-title">
        <div class="container">
            <div class="govbh-date-content mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i> 05 May, 2024</div>
            <h2 id="news-section-title">SLRB organizes a discussion forum to facilitate all procedures, transactions, and to support the electronic transformation of services</h2><!-- id comes from section aria-labelledby -->
            <!-- Slider Starts -->
            <div class="govbh-carousel-block mb-4 mt-4">
                <div class="govbh-carousel"
                    ...
                    <div class="govbh-carousel__slider swiper" aria-roledescription="carousel" role="region" aria-label="News Slider">
                            ...
                            <div class="swiper-slide" tabindex="0" role="group" >
                                <div class="govbh-image-block govbh-image-block--with-overlay" >
                                    <picture>
                                        ...
                                        <img loading="lazy" src="../images/banner-006.webp" width="1293" height="727" alt="About the Ministry" aria-hidden="true"><!--767*320-->
                                    </picture>
                                    <div class="govbh-image-block__playicon"><i class="ph-fill ph-play-circle" aria-hidden="true"></i></div>
                                    <div class="govbh-image-block__caption"><strong>About the Ministry</strong> (YouTube video, 82 seconds, Arabic only)</div>
                                    <a class="govbh-image-block__playicon cbbox-01" data-cb-gallery="cbbox-01" data-cb-type="video" href="https://www.youtube.com/embed/Qp0_6AcGmCg?rel=0&amp;wmode=transparent&amp;autoplay=1" title="About the Ministry, YouTube video, 82 seconds, Arabic only" aria-label="About the Ministry, YouTube video, 82 seconds, Arabic only" role="button"><i class="ph-fill ph-play-circle" aria-hidden="true"></i></a>
                                    <!-- Transcript Starts -->
                            ...
                            <div class="swiper-slide" tabindex="0" role="group">
                                <div class="govbh-image-block">
                                    <picture>
                                        ...
                                        <img src="../images/banner-032.webp" width="1293" height="727" alt="About the Ministry" loading="lazy"><!--767*320-->
                                    </picture>
                                </div>
                            </div>
                        </div>
            ...
            <div class="govbh-content-block pt-lg-2 pt-md-0 pt-0">
                <p><strong>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet arcu volutpat, dictum lorem sollicitudin, finibus mauris. Quisque nisi nulla, imperdiet a consequat a, auctor elementum augue. Etiam sed lorem et enim aliquet sagittis porttitor sit amet odio. Maecenas et nisl a velit euismod pellentesque ac quis eros. </strong></p>
                ...
                <p>The website will also reflect future plans, development programs, projects, services, and links with various official departments and institutions, enhancing the role of the bureau in fulfilling its tasks that started in the early 1920s. It will continue its role in providing various advanced survey services in all their forms and expediting property registration.</p>
                <blockquote class="govbh-blockquote pb-lg-2 pb-md-0 pb-0" role="region" aria-label="Quote from the Chief Executive Officer">
            ...
            <div class="govbh-nav-group mt-4" role="region" aria-label="Navigation Helper">
                <!-- Back to News Listing Button -->
                <a href="news.html" class="govbh-btn govbh-btn--withoutline govbh-btn--left-icon" aria-label="Back to news list page"><i class="ph ph-arrow-elbow-left-up" aria-hidden="true"></i>Back to News Listing</a>
                <!-- Previous & Next Starts --> 
                <div class="govbh-prevnext-nav mt-4 govbh-content-box bg--light-brand">
                    <a href="#" class="govbh-prevnext-nav__item" aria-label="Previous News: Duis sit amet arcu volutpat, dictum lorem sollicitudin" rel="prev">
                    ...
                    <a href="#" class="govbh-prevnext-nav__item text-md-end text-sm-start text-start" aria-label="Next News: Duis sit amet arcu volutpat, dictum lorem sollicitudin" rel="next">
        ...
        <div class="container">
            ...
            <div class="govbh-carousel"
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-md-6 col-sm-8 col-9"><h2 id="related-page-title" class="m-0">Related News</h2></div>
                ...
                <div class="govbh-carousel__slider swiper" aria-roledescription="carousel" role="region" aria-label="Related News Slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" tabindex="0" role="group">
                                ...
                                <div class="govbh-card__head p-0">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-008.webp" width="623" height="351" alt="Lorem ipsum dolor sit amet consectetur" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i> 29 May, 2025</div>
                                        <h3 id="news-title-1" class="govbh-card__title"><a href="news-detail-page.html">Lorem ipsum dolor sit amet consectetur</a></h3>
                                    </div>
                                </div>
                                ...
                                <div class="govbh-card__head p-0">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-025.webp" width="623" height="351" alt="Lorem ipsum dolor sit amet consectetur1" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i> 29 May, 2025</div>
                                        <h3 id="news-title-2" class="govbh-card__title"><a href="news-detail-page.html">Maecenas ultricies sagittis mi varius ullamcorper</a></h3>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
                                    <div class="govbh-card__foot-button">
                                ...
                                <div class="govbh-card__head p-0">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-026.webp" width="623" height="351" alt="Lorem ipsum dolor sit amet consectetur2" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i> 29 May, 2025</div>
                                        <h3 id="news-title-3" class="govbh-card__title"><a href="news-detail-page.html">Develop New Power & Water Plant in Sitra</a></h3>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
                                    <div class="govbh-card__foot-button">
                                ...
                                <div class="govbh-card__head p-0">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-027.webp" width="623" height="351" alt="Lorem ipsum dolor sit amet consectetur3" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1"><i class="ph ph-calendar-check" aria-hidden="true"></i> 29 May, 2025</div>
                                        <h3 id="news-title-4" class="govbh-card__title"><a href="news-detail-page.html">Develop New Power & Water Plant in Sitra</a></h3>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
                                    <div class="govbh-card__foot-button">
