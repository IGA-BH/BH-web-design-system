            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li>
                            <a href="#" aria-label="Go to reports">Reports</a>
                        </li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">Data Acquisition and Processing</li>
                    </ul>
                </nav>
            ...
            <div class="row g-lg-4 g-md-3 g-3">
                <div class="col-12">
                    ...
                    <div class="govbh-content-block">
                        <div class="govbh-date-content mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i> 2025</div>
                        <h2 id="report-page-title">Data Acquisition and Processing</h2>
                        ...
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean placerat quis dolor non ultricies. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent tempor fringilla fringilla. Vestibulum nec malesuada nisl, ac gravida dolor. Vivamus efficitur facilisis mauris, vitae sagittis nibh semper in.</p>
                        <a href="../images/samplepdf.pdf" class="govbh-btn govbh-btn--primary" target="_blank" aria-label="Download: Resolution on Regulating the Work of Energy Efficiency Specialised Companies, PDF, 13 MB, 8 pages">Download Report <i class="ph ph-download-simple" aria-hidden="true"></i></a>
