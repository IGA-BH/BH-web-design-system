            ...
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    <li class="govbh-breadcrumb__item-home">
                        <a href="#" aria-label="Go to home"><i class="ph ph-house" aria-hidden="true"></i><span>الصفحة الرئيسية</span></a>
                    </li>
                    <li class="govbh-breadcrumb__item-last" aria-current="page">الفعاليات </li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="events-page-title">
    <div class="container">
        <div class="govbh-abstract">
            <p class="mb-0">الفعاليات التي تنظمها الوزارة للمواطنين و الموظفين</p>
        </div>
        ...
        <!-- List Grid Starts -->
        <div role="region" aria-label="جميع الفعاليات">
            <!-- Title and Sort by Starts -->
            <div class="row align-items-center g-3 mb-4">
                <div class="col-xxl-8 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
                    <h2 id="events-page-title" class="m-0">جميع الفعاليات </h2><!-- id comes from section aria-labelledby -->
                </div>
                        ...
                        <div class="govbh-card__head pb-sm-0 pb-2">
                            ...
                            <div class="govbh-card__head-content pb-2">
                                <h3 id="events-card-1" class="govbh-card__title"><a href="events-detail-page.html"
                                        aria-label="Readmore: eCommerce Conference for SMEs">مؤتمر التجارة الإلكترونية للمؤسسات الصغيرة و المتوسطة</a></h3>
                                <div class="govbh-card__date mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    20 -23 مايو 2025</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-clock" aria-hidden="true"></i> 10:00 صباحا - 12:00 مساء </div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-map-pin" aria-hidden="true"></i>
                                    مركز البحرين العالمي للمعارض</div>
                            </div>
                        </div>
                        ...
                        <div class="govbh-card__head pb-sm-0 pb-2">
                            ...
                            <div class="govbh-card__head-content pb-2">
                                <h3 id="events-card-2" class="govbh-card__title"><a href="events-detail-page.html"
                                        aria-label="Readmore: Bab Al-Bahrain Forum 2025">منتدى باب البحرين</a></h3>
                                <div class="govbh-card__date mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    23 مايو 2025</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-clock" aria-hidden="true"></i> 10:00 صباحا - 12:00 مساء</div>
                        ...
                        <div class="govbh-card__head pb-sm-0 pb-2">
                            ...
                            <div class="govbh-card__head-content pb-2">
                                <h3 id="events-card-3" class="govbh-card__title"><a href="events-detail-page.html"
                                        aria-label="Readmore: Workshop Organizational Culture">ورشة " الثقافة المؤسسية"</a></h3>
                                <div class="govbh-card__date mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i> 25 مايو 2025</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-clock" aria-hidden="true"></i> 8:00 صباحا - 10:00 مساء</div>
                        ...
                        <div class="govbh-card__head pb-sm-0 pb-2">
                            ...
                            <div class="govbh-card__head-content">
                                <h3 id="events-card-4" class="govbh-card__title"><a href="events-detail-page.html"
                                        aria-label="Readmore: Lorem ipsum dolor sit amet">منتدى باب البحرين</a>
                                </h3>
                                <div class="govbh-card__date mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i> 25 مايو 2025</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-clock" aria-hidden="true"></i> 8:00 صباحا - 10:00 مساء</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-map-pin" aria-hidden="true"></i> قاعة المجلس - غرفة البحرين</div>
                        ...
                        <div class="govbh-card__head pb-sm-0 pb-2">
                            ...
                            <div class="govbh-card__head-content">
                                <h3 id="events-card-5" class="govbh-card__title"><a href="events-detail-page.html"
                                        aria-label="Readmore: Lorem ipsum dolor sit amet">ورشة " الثقافة المؤسسية"</a>
                                </h3>
                                <div class="govbh-card__date mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i>
                                    23 مايو 2025</div>
                                <div class="govbh-card__date mb-2"><i class="ph ph-clock" aria-hidden="true"></i> 8:00 صباحا - 10:00 مساء</div>
