        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">Services</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="services-page-title">
    <h2 id="services-page-title" class="visually-hidden">All E-Services</h2>
    <div class="container">
        ...
        <form action="#" autocomplete="on" class="govbh-search-card bg--grey mt-4 mb-lg-5 mb-md-4 mb-4">
            <div class="govbh-search-card__title govbh-fs-h5 text--brand">Find an E-Service</div>
            ...
            <div class="row g-4 mb-md-5 mb-sm-4 mb-4">
                        ...
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <h3 id="service-title-1" class="govbh-card__title"><a href="services-detail.html"
                                        aria-label="Service: Application for Property Registration">Application for Property
                                        Registration</a></h3>
                        ...
                        <div class="govbh-card__foot">
                            <div class="govbh-card__foot-button">
                                <a href="#" target="_blank"
                                    aria-label="Application for Property Registration - Open in a new window"
                                    class="govbh-btn govbh-btn--outline govbh-btn--medium z-1">Launch <i
                                ...
                                <a href="services-detail.html" class="govbh-btn govbh-btn--withoutline govbh-btn--medium"
                                    aria-label="Service: Application for Property Registration">Details <i
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article class="govbh-card" role="region" aria-labelledby="service-title-2">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <h3 id="service-title-2" class="govbh-card__title"><a href="services-detail.html"
                                        aria-label="Service: Online Appointments Services">Online Appointments Services</a>
                                </h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
                        ...
                        <div class="govbh-card__foot">
                            <div class="govbh-card__foot-button">
                                <a href="#" target="_blank" aria-label="Online Appointments Services - Open in a new window"
                                    class="govbh-btn govbh-btn--outline govbh-btn--medium z-1">Launch <i
                                        class="ph ph-arrow-square-out" aria-hidden="true"></i></a>
                                <a href="services-detail.html" class="govbh-btn govbh-btn--withoutline govbh-btn--medium"
                                    aria-label="Service: Online Appointments Services">Details <i class="ph ph-arrow-right"
                        ...
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <h3 id="service-title-3" class="govbh-card__title"><a href="services-detail.html"
                                        aria-label="Service: Cadastral Survey Services">Cadastral Survey Services</a></h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
                        </div>
                            ...
                            <div class="govbh-card__foot-button">
                                <a href="#" target="_blank" aria-label="Cadastral Survey Services - Open in a new window"
                                    class="govbh-btn govbh-btn--outline govbh-btn--medium z-1">Launch <i
                                        class="ph ph-arrow-square-out" aria-hidden="true"></i></a>
                                <a href="services-detail.html" class="govbh-btn govbh-btn--withoutline govbh-btn--medium"
                                    aria-label="Service: Cadastral Survey Services">Details <i class="ph ph-arrow-right"
                                        aria-hidden="true"></i></a>
                            </div>
                            <div class="govbh-card__foot-icon"><i class="ph ph-arrow-right" aria-hidden="true"></i></div>
                        </div>
