                ...
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        <li class="govbh-breadcrumb__item-home">
                            <a href="index.html" aria-label="Go to home"><i class="ph ph-house" aria-hidden="true"></i><span>الصفحة الرئيسية</span></a>
                        </li>
                        <li>
                            <a href="legislations.html" aria-label="Go to reports">التشريعات</a>
                        </li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">قرار بشأن تنظيم عمل الشركات المتخصصة في كفاءة الطاقة</li>
                    </ul>
                </nav>
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <h1>تفاصيل التشريعات</h1>
                </div>
            ...
            <div class="row g-lg-4 g-md-3 g-3">
                <div class="col-12">
                    ...
                    <div class="govbh-content-block">
                        <div class="govbh-date-content mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i> 24 مايو 2025</div>
                        <h2 id="legislations-page-title">قرار بشأن تنظيم عمل الشركات المتخصصة في كفاءة الطاقة</h2>
                        <div class="govbh-abstract">
                            <p>يهدف هذا القرار إلى تنظيم عمل شركات خدمات كفاءة الطاقة في البحرين، وتحديد المعايير اللازمة للحصول على الاعتماد، لضمان تقديم خدمات عالية الجودة في مجال كفاءة الطاقة.</p>
                        </div>
                        <p>يعتبر هذا القرار خطوة هامة لتنظيم قطاع كفاءة الطاقة في البحرين، من خلال توفير معايير واضحة للاعتماد، وتنظيم إجراءات التقديم. كما يساهم القرار في تحسين كفاءة استهلاك الطاقة في المنشآت المختلفة، مما يعزز الاستدامة البيئية ويسهم في تحقيق أهداف الحكومة في ترشيد استخدام الموارد.</p>
                        <p><strong>أنواع الاعتماد:</strong></p>
                        <ul class="govbh-content-block__list pb-3">
                            <li>الاعتماد الكامل: يتم منحه للشركات التي استوفت جميع المتطلبات.</li>
                            <li>الاعتماد المؤقت: يُمنح للشركات التي لم تنفذ مشاريع كافية بعد.</li>
                        </ul>
                        <p>يعتبر هذا القرار خطوة هامة لتنظيم قطاع كفاءة الطاقة في البحرين، من خلال توفير معايير واضحة للاعتماد، وتنظيم إجراءات التقديم. كما يساهم القرار في تحسين كفاءة استهلاك الطاقة في المنشآت المختلفة، مما يعزز الاستدامة البيئية ويسهم في تحقيق أهداف الحكومة في ترشيد استخدام الموارد.</p>
                        <a href="../images/samplepdf.pdf" class="govbh-btn govbh-btn--primary" target="_blank" aria-label="Download: Resolution on Regulating the Work of Energy Efficiency Specialised Companies, PDF, 13 MB, 8 pages">تحميل التشريع <i class="ph ph-download-simple" aria-hidden="true"></i></a>
