            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li>
                            <a href="#" aria-label="Go to about">We Care About You</a>
                        </li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">Education and Training</li>
                    </ul>
                </nav>
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <h1>We Care About You Details</h1>
                </div>
            ...
            <div class="row g-lg-4 g-md-3 g-3">
                <div class="col-12">
                    ...
                    <div class="govbh-content-block">
                        <h2 id="wecare-page-title">Education and Training</h2>
