...
?>
            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li class="govbh-breadcrumb__item-last" aria-current="page">الشركاء</li>
                    </ul>
                </nav>
    ...
    <section class="govbh-section" aria-labelledby="partners-title">
        <h2 id="partners-title" class="visually-hidden">Partners</h2>
        <div class="container">
            <!-- Two Column Starts -->
            <div class="row">
                        ...
                        <div id="asidecategories" class="govbh-side-widget__content">
                            <ul class="govbh-side-widget__list">
                                <li class="govbh-side-widget__item active">
                                    <a href="javascript:void(0);">الكل (25)</a>
                                </li>
                                <li class="govbh-side-widget__item">
                                    <a href="javascript:void(0);">محلي (10)</a>
                                </li>
                                <li class="govbh-side-widget__item">
                                    <a href="javascript:void(0);">إقليمي (5)</a>
                                </li>
                                <li class="govbh-side-widget__item">
                                    <a href="javascript:void(0);">دولي (3)</a>
                                </li>
                            </ul>
                        </div>
                    </aside>
                ...
                <div class="col-xxl-9 col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12">
                    <div class="govbh-abstract">
                        <p class="mb-0">في اسم الجهة، نؤمن بأن النجاح لا يتحقق بمفردنا، بل من خلال التعاون البنّاء والشراكات الإستراتيجية مع مؤسسات وجهات تشاركنا القيم والرؤية.</p>
                    </div>
                    <!-- Partners Section Starts -->
                    <ul class="govbh-partners-list mt-4 pt-2 pb-2">
                        <li class="govbh-partners-list__item">
                            <a href="https://www.slrb.gov.bh/" target="_blank" rel="noopener noreferrer" aria-label="Survay and Land Registration Bureau - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/survay-and-land-registration-bureau.svg" alt="Survay and Land Registration Bureau" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">جهاز المساحة والتسجيل العقاري</span>
                            </a>
                        </li>
                        <li class="govbh-partners-list__item">
                            <a href="https://www.ewa.bh/" target="_blank" rel="noopener noreferrer" aria-label="Electricity and Water Authority - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/ewa.svg" alt="Electricity and Water Authority" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">وزارة الكهرباء والماء</span>
                            </a>
                        </li>
                        <li class="govbh-partners-list__item">
                            <a href="https://services.bahrain.bh/wps/portal/tawasul/en/!ut/p/z1/hY9BC4JAEIV_SwevzrRibd1WI0kMpYJsL6GxrYa6oqb9_KQiKJLmNm--9x4DHELgRdSmMmpSVURZvx_45EipY48JJS6uPYosCCibBbaBZAr7fwDvzzgwDGErij6DP7B3ir9bMGTM9cnSMwn65AV8u60NsQxEZwD4KHKBy0zFz59YERtUAq_EWVSi0q9VLydNU9ZzDTXsuk6XSslM6CeVa_jLkqi6gfCThDIPb6uLmbUeG90BfcBaTQ!!/dz/d5/L3dHQSEvUUt3SS9nQSEh/" target="_blank" rel="noopener noreferrer" aria-label="Tawasul - The National Suggestions & Complaints System - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/tawasul.svg" alt="Tawasul - The National Suggestions & Complaints System" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">تواصل</span>
                            </a>
                        </li>
                        <li class="govbh-partners-list__item">
                            <a href="https://www.bahrain.bh/wps/portal/en/BNP/GSX-UI-AllEntities/GSX-UI-EntityDetails?entityID=58" target="_blank" rel="noopener noreferrer" aria-label="Bahrain Polytechnic - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/poly_logo.png" alt="Bahrain Polytechnic" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">بوليتكنك البحرين</span>
                            </a>
                        </li>
                        <li class="govbh-partners-list__item">
                            <a href="https://www.iga.gov.bh/en/" target="_blank" rel="noopener noreferrer" aria-label="Information & eGovernment Authority - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/iga_logo.png" alt="Information & eGovernment Authority" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">هيئة المعلومات والحكومة الإلكترونية</span>
                            </a>
                        </li>
                        <li class="govbh-partners-list__item">
                            <a href="https://www.iga.gov.bh/en/" target="_blank" rel="noopener noreferrer" aria-label="Government of Bahrain - Open in a new window">
                                <div class="govbh-partners-list__item-img">
                                    <img src="../images/utilities/partners/gov-bahrain.svg" alt="Government of Bahrain" width="350" height="80">
                                </div>
                                <span class="govbh-is-external">حكومة البحرين</span>
                            </a>
                        </li>
                    </ul>
