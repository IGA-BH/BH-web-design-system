        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">Organizational Chart</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="organizational-chart-page-title">
    ...
    <div class="container">
        <img src="../images/organization-en-light.png" alt="Organizational Chart" class="govbh-logo-light">
        <img src="../images/organization-en-dark.png" class="govbh-logo-dark" alt="Organizational Chart Dark">
        <div class="d-flex justify-content-center">
            <a href="../images/organization-en-light.png" target="_blank" aria-label="Download: Organizational Chart, PDF, 12KB, 1 pages - Open in a new window" class="govbh-btn govbh-btn--outline govbh-btn--left-icon mt-5"><i class="ph ph-download-simple" aria-hidden="true"></i> Download PDF (12Kb, 1 Page)</a>
        </div>
