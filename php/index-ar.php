...
?>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12 col-12">
                                        ...
                                        <div data-swiper-parallax-x="-15%">
                                            <p>تلتزم هيئة المساحة والمساحة بتعزيز التنمية الاقتصادية المستدامة من خلال التخطيط الاستراتيجي والمبادرات.</p>
                                        </div>
    ...
    <section class="govbh-section bg--darkmode-primary" aria-labelledby="section-title-02">
        <div class="container">
            <h2 id="section-title-02">نهتم بك</h2>
