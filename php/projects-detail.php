...
?>
            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li><a href="#" aria-label="Go to Projects">Projects</a></li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">Application for Property Registration</li>
                    </ul>
                </nav>
    ...
    <article class="govbh-section" role="region" aria-labelledby="project-section-title">
        <div class="container">
            <div class="govbh-block-status mb-1 govbh-block-status--completed"><i class="ph ph-calendar-check" aria-hidden="true"></i> 12 Jun, 2025 <span>Completed</span></div>
            <h2 id="project-section-title">Develop New Power & Water Plant in Sitra</h2><!-- id comes from section aria-labelledby -->
            <!-- Slider Starts -->
            <div class="govbh-carousel-block mb-4 mt-4">
                <div class="govbh-carousel"
                    ...
                    <div class="govbh-carousel__slider swiper" aria-roledescription="carousel" role="region" aria-label="Develop New Power & Water Plant in Sitra Slider">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" tabindex="0" role="group">
                                <div class="govbh-image-block govbh-image-block--with-overlay">
                                    <picture>
                                        <source media="(min-width: 1200px)" srcset="../images/banner-036.webp"><!--1600*750 Default image-->
                                        <source media="(min-width: 992px)" srcset="../images/banner-036.webp"><!--1199*500-->
                                        <source media="(min-width: 768px)" srcset="../images/banner-036.webp"> <!--991*413-->
                                        <img src="../images/banner-036.webp" width="1293" height="727" alt="Develop New Power & Water Plant in Sitra" loading="lazy"><!--767*320-->
                                    </picture>
                                    <div class="govbh-image-block__playicon"><i class="ph-fill ph-play-circle" aria-hidden="true"></i></div>
                                    <div class="govbh-image-block__caption"><strong>Develop New Power & Water Plant in Sitra</strong> (YouTube video, 82 seconds, Arabic only)</div>
                                    <a class="govbh-image-block__playicon cbbox-01" data-cb-gallery="cbbox-01" data-cb-type="video" href="https://www.youtube.com/embed/Qp0_6AcGmCg?rel=0&amp;wmode=transparent&amp;autoplay=1" title="Develop New Power & Water Plant in Sitra, YouTube video, 82 seconds, Arabic only" aria-label="Watch a Video of completed project: Develop New Power & Water Plant in Sitra, YouTube video, 82 seconds, Arabic only" role="button"><i class="ph-fill ph-play-circle" aria-hidden="true"></i></a>
                                    <!-- Transcript Starts -->
                            ...
                            <div class="swiper-slide" tabindex="0" role="group">
                                <div class="govbh-image-block">
                                    <picture>
                                        <source media="(min-width: 1200px)" srcset="../images/banner-010.webp"><!--1600*750 Default image-->
                                        <source media="(min-width: 992px)" srcset="../images/banner-010.webp"><!--1199*500-->
                                        <source media="(min-width: 768px)" srcset="../images/banner-010.webp"> <!--991*413-->
                                        <img src="../images/banner-010.webp" width="1293" height="727" alt="About the Ministry1" loading="lazy"><!--767*320-->
                                    </picture>
                                </div>
                            </div>
                        </div>
            ...
            <div class="govbh-content-block pt-lg-2 pt-md-0 pt-0">
                <div class="row">
                    <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                        <div class="govbh-abstract">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc mollis cursus sapien sed varius. Nunc mattis rhoncus massa at accumsan ut id aliquet urna.  Lorem ipsum dolor sit amet, consectetur adipiscing elit.Nunc mollis cursus sapien sed varius. Nunc mattis rhoncus massa at accumsan.</p>
                        </div>
                        <p>The website represents a transitional stage that comes before the final version, which will be launched, God willing, before the end of the current year 2024, after completing the evaluation of interactive capabilities and applications and developing the content to serve as an infrastructure and an important tool for digital transformation in the entire Survey and Land Registry Bureau.</p>
                    </div>
                    <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                        <div class="govbh-content-box bg--light-brand mb-3">
                            <div class="govbh-carousel"
                                data-carousel="custom" 
                                data-slidesperview-xxxs="1" 
                                data-slidesperview-xxs="1" 
                                ...
                                data-slidesperview-lg="1" 
                                data-slidesperview-xl="1">
                                <div class="govbh-carousel__slider swiper" aria-roledescription="carousel" role="region" aria-label="Project Count Slider">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" tabindex="0" role="group">
                                            <div class="govbh-odometer govbh-odometer--large text-center" dir="ltr" aria-live="polite">
                                                <div class="odometer" data-format="" data-count="1200" data-status="yes" aria-hidden="true">0</div>
                                                <div class="opendata-count-sign">Megawatts (MW)<br>Power Generation Capacity</div>
                                                <span class="visually-hidden">1200 Megawatts (MW) Power Generation Capacity</span>
                                            </div>
                                        </div>
                                        <div class="swiper-slide" tabindex="0" role="group">
                                            <div class="govbh-odometer govbh-odometer--large text-center" dir="ltr" aria-live="polite">
                                                <div class="odometer" data-format="" data-count="1985" data-status="yes" aria-hidden="true">0</div>
                                                <div class="opendata-count-sign">Megawatts (MW)<br>Power Generation Capacity</div>
                                                <span class="visually-hidden">1985 Megawatts (MW) Power Generation Capacity</span>
                                            </div>
                                        </div>
                                        <div class="swiper-slide" tabindex="0" role="group">
                                            <div class="govbh-odometer govbh-odometer--large text-center" dir="ltr" aria-live="polite">
                                                <div class="odometer" data-format="" data-count="1500" data-status="yes" aria-hidden="true">0</div>
                                                <div class="opendata-count-sign">Megawatts (MW)<br>Power Generation Capacity</div>
                                                <span class="visually-hidden">1500 Megawatts (MW) Power Generation Capacity</span>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Pagination -->
                ...
                <div class="govbh-content-box bg--brand mt-3 mb-4">
                    <blockquote class="govbh-blockquote theme--dark" role="region" aria-label="Quote from the Chief Executive Officer">
            ...
            <div class="govbh-nav-group mt-4" role="region" aria-label="Navigation Helper">
                ...
                <a href="projects.html" class="govbh-btn govbh-btn--withoutline govbh-btn--left-icon" aria-label="Back to project list page"><i class="ph ph-arrow-elbow-left-up" aria-hidden="true"></i>Back to Projects Listing</a>
                <!-- Previous & Next Starts --> 
                <div class="govbh-prevnext-nav mt-4 govbh-content-box bg--light-brand">
                    <a href="#" class="govbh-prevnext-nav__item" aria-label="Previous Project: Duis sit amet arcu volutpat, dictum lorem sollicitudin" rel="prev">
                    ...
                    <a href="#" class="govbh-prevnext-nav__item text-md-end text-sm-start text-start" aria-label="Next Project: Duis sit amet arcu volutpat, dictum lorem sollicitudin" rel="next">
        ...
        <div class="container">
            ...
            <div class="govbh-carousel"
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-md-6 col-sm-8 col-9"><h2 id="related-page-title" class="m-0">Other Projects</h2></div>
                ...
                <div class="govbh-carousel__slider swiper" aria-roledescription="carousel" role="region" aria-label="Other Projects Slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" tabindex="0" role="group">
                                ...
                                <div class="govbh-card__head">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-018.webp" width="623" height="351" alt="Develop New Power & Water Plant in Sitra" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1">12 May, 2020<span class="govbh-card__status--completed">Completed</span></div>
                                        <h3 id="project-title-1" class="govbh-card__title"><a href="#" aria-label="Completed Project: Develop New Power & Water Plant in Sitra">Develop New Power & Water Plant in Sitra</a></h3>
                                ...
                                <div class="govbh-card__head">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-019.webp" width="623" height="351" alt="Develop New Power & Water Plant in Sitra One" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1">12 May, 2020<span class="govbh-card__status--progress">In Progress</span></div>
                                        <h3 id="project-title-2" class="govbh-card__title"><a href="#" aria-label="In Progress Project: Develop New Power & Water Plant in Sitra">Develop New Power & Water Plant in Sitra</a></h3>
                                        <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB for Cadastral Services.</div>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
                                ...
                                <div class="govbh-card__head">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-020.webp" width="623" height="351" alt="Develop New Power & Water Plant in Sitra two" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1">12 May, 2020<span class="govbh-card__status--completed">Completed</span></div>
                                        <h3 id="project-title-3" class="govbh-card__title"><a href="#" aria-label="Completed Project: Develop New Power & Water Plant in Sitra">Develop New Power & Water Plant in Sitra</a></h3>
                                        <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB for Cadastral Services.</div>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
                                ...
                                <div class="govbh-card__head">
                                    <div class="govbh-card__head-image">
                                        <picture>
                                            ...
                                            <img src="../images/banner-021.webp" width="623" height="351" alt="Develop New Power & Water Plant in Sitra 4" loading="lazy">
                                        </picture>
                                    </div>
                                    <div class="govbh-card__head-content">
                                        <div class="govbh-card__date mb-1">12 May, 2020<span class="govbh-card__status--progress">In Progress</span></div>
                                        <h3 id="project-title-4" class="govbh-card__title"><a href="#" aria-label="In Progress Project: Develop New Power & Water Plant in Sitra">Develop New Power & Water Plant in Sitra</a></h3>
                                        <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB for Cadastral Services.</div>
                                    </div>
                                </div>
                                <div class="govbh-card__foot pe-none">
