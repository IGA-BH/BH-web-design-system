            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li class="govbh-breadcrumb__item-last" aria-current="page">Lorem ipsum dolor</li>
                    </ul>
                </nav>
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <h1>General Template</h1>
                </div>
...
<li><a href="#" target="_blank" aria-label="Share this page on Facebook" rel="noopener noreferrer"><span class="icon-facebook" aria-hidden="true" role="presentation"></span></a></li>                        <li><a href="#" target="_blank" aria-label="Share this page on Whatsapp" rel="noopener noreferrer"><span class="icon-whatsapp" aria-hidden="true" role="presentation"></span></a></li>
    ...
    <section class="govbh-section" aria-labelledby="general-page-title">
        <div class="container">
            <div class="govbh-date-content mb-2"><i class="ph ph-calendar-check" aria-hidden="true"></i> 24 May, 2025</div>
            <h2 class="text--brand" id="general-page-title">Lorem ipsum dolor</h2>
            <!-- Slider Starts -->
            ...
            <div class="govbh-content-block pt-lg-2 pt-md-0 pt-0">
                ...
                <div class="row g-lg-4 g-md-3 g-3">
                    <div class="col-12">
                        ...
                        <h3 class="text--brand">Lorem ipsum dolor</h3>
                        <div class="govbh-abstract">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis sit amet arcu volutpat, dictum lorem sollicitudin, finibus mauris. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc sagittis ipsum eget magna sollicitudin, lobortis faucibus orci elementum. </p>
                        </div>
                        <p>Nunc sagittis ipsum eget magna sollicitudin, lobortis faucibus orci elementum. Donec at augue a mi rutrum pharetra sit amet sit amet felis. Sed sed faucibus magna. Nulla egestas metus lacus, in consectetur ipsum dignissim in. Nulla egestas metus lacus, in consectetur ipsum dignissim in.</p>
                    </div>
                </div>
                ...
                <div class="row g-lg-4 g-md-3 g-3">
                    <div class="col-12">
                        <div class="col-lg-6 col-md-12 float-md-end ms-lg-5 ms-md-0 ms-0 mb-lg-4 mb-md-3 mb-3 z-1 position-relative">
                            ...
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean placerat quis dolor non ultricies. Interdum et malesuada fames ac ante ipsum primis in faucibus. Praesent tempor fringilla fringilla. Vestibulum nec malesuada nisl, ac gravida dolor. Vivamus efficitur facilisis mauris, vitae sagittis nibh semper in.</p>
                            <ul class="pb-3">
                                <li>Lorem ipsum dolor sit amet, consectetur adipiscing eliteros rutrum lobortis.</li>
                                <li>Lorem ipsum dolor sit amet, consectetur dignissim tincidunt tortor, at mollis eros rutrum lobortis.</li>
                                <li>Lorem ipsum dolor sit dignissim tincidunt tortor, at mollis eros rutrum lobortis.</li>
                                <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit dignissim tincidunt tortor, at mollis eros rutrum lobortis.</li>
                                <li>Lorem ipsum dolor sit amet, consectetur in dignissim tincidunt tortor, at mollis eros rutrum lobortis.</li>
                        ...
                        <tbody>
                            <tr>
                                <td class="govbh-datatable__table--bold">
                                    <a href="#"><b>Bader Sultan Jumma</b></a>
                                </td>
                                <td>18</td>
                                <td>12/12/1981</td>
                                <td>Bahraini</td>
                                <td><div class="govbh-datatable__table--success"><i class="ph-bold ph-check"></i> Yes</div></td>                          
                            </tr>
                            <tr>
                                <td class="govbh-datatable__table--bold">
                                    <a href="#"><b>Mohammed Ali</b></a>
                                </td>
                                <td>19</td>
                                <td>12/12/1965</td>
                                <td>Saudi</td>
                                <td><div class="govbh-datatable__table--failure"><i class="ph-bold ph-x-circle"></i> No</div></td>                          
                            </tr>
                            <tr>
                                <td class="govbh-datatable__table--bold">
                                    <a href="#"><b>Hassan Sultan Jumma</b></a>
                                </td>
                                <td>22</td>
                                <td>12/12/1945</td>
                                <td>Qatar</td>
                ...
                <a href="../images/samplepdf.pdf" class="govbh-btn govbh-btn--primary" aria-label="Download: Resolution on Regulating the Work of Energy Efficiency Specialised Companies, PDF, 13 MB, 8 pages">Download Option <i class="ph ph-download-simple" aria-hidden="true"></i></a>
