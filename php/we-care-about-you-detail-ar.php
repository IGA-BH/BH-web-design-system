            ...
            <div class="row g-2 align-items-center">
                <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                    <ul class="govbh-breadcrumb__group">
                        ...
                        <li>
                            <a href="#" aria-label="Go to about">نهتم بكم</a>
                        </li>
                        <li class="govbh-breadcrumb__item-last" aria-current="page">التعليم والتدريب</li>
                    </ul>
                </nav>
                <div class="col-lg-8 col-md-8 col-sm-12 col-12">
                    <h1>نهتم بكم تفاصيل</h1>
                </div>
            ...
            <div class="row g-lg-4 g-md-3 g-3">
                <div class="col-12">
                    ...
                    <div class="govbh-content-block">
                        <h2 id="wecare-page-title">التعليم والتدريب</h2>
                        <div class="govbh-abstract">
                            <p>تُعد مملكة البحرين من الدول الرائدة إقليميًا في مجال التعليم منذ تأسيس أولى مدارسها عام 1919. وتمتاز المملكة بمنظومة تعليمية شاملة ومتميزة تضع جودة التعليم الشامل في صدارة أولوياتها، وهو ما ينعكس في نسبة القرائية تتجاوز 95%، وفي تصنيفها العالي في مؤشر التنمية البشرية. ويعتمد النظام التعليمي في البحرين على مبدأ التعلم مدى الحياة، مع التركيز على تنمية القدرات الفردية بما يدعم الرؤية الوطنية نحو الابتكار والتقدم والشمولية في المجتمع.</p>
                        </div>
                        <p>بموجب قانون التعليم رقم (27) لسنة 2005، المادة (6) بشأن "التعليم للجميع"، توفر مملكة البحرين التعليم المجاني والجيد لجميع الأفراد، سواء من المواطنين أو المقيمين. وترتكز سياسة التعليم على الشمولية من خلال دمج الطلبة من ذوي الاحتياجات الخاصة ضمن التعليم الحكومي مع توفير الدعم والبيئة المناسبين لهم، وذلك وفقاً للخطة الاستراتيجية للتعليم (2023–2026) التي تهدف إلى الاستثمار في البنية التحتية للتعليم، وتطوير المناهج وتعزيز الكفاءات التعليمية.</p>
                        <p>تبدأ مرحلة التعليم الإلزامي في مملكة البحرين من سن السادسة وتستمر لمدة تسع سنوات من التعليم الأساسي والإعدادي، تليها ثلاث سنوات من التعليم الثانوي ضمن مسارات متنوعة، قبل الانتقال إلى مرحلة التعليم العالي. ويتميز النظام التعليمي في البحرين بالمرونة والقدرة على التكيّف مع التطورات العالمية من خلال توفير بيئة تعليمية رقمية متقدمة متوافقة مع التوجهات الدولية.</p>
                        <p><strong>تحديثات ذات صلة</strong></p>
                        <ul class="govbh-content-block__list pb-3">
                           <li>الوزارة تعقد لقاءً بشأن المشاركة في الدراسة الدولية للمهارات القرائية.</li>
                           <li>تم الاعلان عن منحة كرسي جلالة الملك حمد الأكاديمي للتعليم الرقمي</li>
                           <li>ارتفاع عدد الخليجيين الدارسين في مؤسسات التعليم العالي البحرينية 4.6 % خلال 5 سنوات</li>
                           <li>افتتاح مدرسة المستشفى المصغرة</li>
                           <li>الإعلان عن نظام جديد لتحسين المعدل التراكمي قبيل بداية الفصل الدراسي الثاني</li>
                           <li>تم الاعلان عن بدء التسجيل للدفعة الثانية من برنامج تنمية الكوادر التقنية</li>
                        </ul>
                    </div>
                </div>
            </div>
