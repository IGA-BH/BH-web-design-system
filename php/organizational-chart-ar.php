        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">الهيكل التنظيمي</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="organizational-chart-page-title">
    <h2 id="organizational-chart-page-title" class="visually-hidden">Organizational Chart</h2>
    <div class="container">
        <img src="../images/organization-ar-light.png" alt="Organizational Chart" class="govbh-logo-light">
        <img src="../images/organization-ar-dark.png" class="govbh-logo-dark" alt="Organizational Chart Dark">
        <div class="d-flex justify-content-center">
            <a href="../images/organization-ar-light.png" target="_blank" aria-label="Download Organizational Chart, PDF, 12KB, 1 pages - Open in a new window" class="govbh-btn govbh-btn--outline govbh-btn--left-icon mt-5"><i class="ph ph-download-simple" aria-hidden="true"></i> تنزيل ملف PDF (12 كيلوبايت، صفحة واحدة)</a>
        </div>
