        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">Projects</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="projects-page-title">
    <div class="container">
        ...
        <form action="#" autocomplete="on" class="govbh-search-card bg--grey mt-4 mb-lg-5 mb-md-4 mb-4">
            <div class="govbh-search-card__title govbh-fs-h5 text--brand">Find a Project</div>
                ...
                <div class="col-12">
                    <div class="govbh-advanced-search">
                        ...
                        <div class="govbh-advanced-search__body" id="advancesearch" style="display:none;">
                            <fieldset>
                                <legend class="visually-hidden">Advanced Search Fields</legend>
                                <div class="row g-4">
        ...
        <!-- List Grid Starts -->
        <div role="region" aria-label="All Projects">
            <!-- Title and Sort by Starts -->
            <div class="row align-items-center g-3 mb-4">
                <div class="col-lg-8 col-md-6 col-sm-12 col-12">
                    <h2 id="projects-page-title" class="m-0">All Projects</h2><!-- id comes from section aria-labelledby -->
                </div>
            ...
            <div class="row g-4 mb-md-5 mb-sm-4 mb-4">
                    ...
                    <article role="region" aria-labelledby="project-title-1" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 May, 2020<span
                                        class="govbh-card__status--completed">Completed</span></div>
                                <h3 id="project-title-1" class="govbh-card__title"><a href="projects-detail.html"
                                        aria-label="Completed Project: Develop New Power & Water Plant in Sitra">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-2" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2021<span class="govbh-card__status--progress">In
                                        Progress</span></div>
                                <h3 id="project-title-2" class="govbh-card__title"><a href="projects-detail.html"
                                        aria-label="In Progress Project: Develop New Power & Water Plant in Sitra">Develop
                                        New Power & Water Plant in Sitra</a></h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
                        </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-3" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2021<span
                                        class="govbh-card__status--completed">Completed</span></div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-4" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2022<span class="govbh-card__status--progress">In
                                        Progress</span></div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-5" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2023<span
                                        class="govbh-card__status--completed">Completed</span></div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-6" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2024<span class="govbh-card__status--hold">On
                                        Hold</span></div>
                                <h3 id="project-title-6" class="govbh-card__title"><a href="projects-detail.html"
                                        aria-label="On Hold Project: Develop New Power & Water Plant in Sitra">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-7" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            ...
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Aug, 2024<span class="govbh-card__status--progress">In
                                        Progress</span></div>
                        ...
                        <div class="govbh-card__head">
                            <div class="govbh-card__head-image">
                                <picture>
                                    ...
                                    <source media="(min-width: 768px)" srcset="../images/banner-019.webp">
                                    <img src="../images/banner-019.webp" width="623" height="351"
                                        alt="Develop New Power & Water Plant in Sitra 8" loading="lazy">
                                </picture>
                            </div>
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Sept, 2024<span
                                        class="govbh-card__status--progress">In Progress</span></div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                    <article role="region" aria-labelledby="project-title-9" class="govbh-card govbh-card--with-image">
                        <div class="govbh-card__head">
                            <div class="govbh-card__head-image">
                                <picture>
                                    <source media="(min-width: 1200px)" srcset="../images/banner-021.webp">
                                    ...
                                    <source media="(min-width: 768px)" srcset="../images/banner-021.webp">
                                    <img src="../images/banner-021.webp" width="623" height="351"
                                        alt="Develop New Power & Water Plant in Sitra 9" loading="lazy">
                                </picture>
                            </div>
                            <div class="govbh-card__head-content">
                                <div class="govbh-card__date mb-1">12 Jun, 2025<span
                                        class="govbh-card__status--awarded">Awarded</span></div>
                                <h3 id="project-title-9" class="govbh-card__title"><a href="projects-detail.html"
                                        aria-label="Awarded Project: Develop New Power & Water Plant in Sitra">Develop New
                                        Power & Water Plant in Sitra</a></h3>
                                <div class="govbh-card__paragraph">This Service allows the users to get appointment in SLRB
                                    for Cadastral Services.</div>
                            </div>
