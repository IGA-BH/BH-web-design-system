        ...
        <div class="row g-2 align-items-center">
            <nav class="col-12 mb-lg-4 mb-md-3 mb-3 pb-2" tabindex="0" aria-label="Breadcrumbs">
                <ul class="govbh-breadcrumb__group">
                    ...
                    <li class="govbh-breadcrumb__item-last" aria-current="page">التقارير</li>
                </ul>
            </nav>
...
<section class="govbh-section" aria-labelledby="report-page-title">
    <div class="container">
        <!-- Search Container Starts -->
        <form action="#" autocomplete="on" class="govbh-search-card bg--grey mb-lg-5 mb-md-4 mb-4">
            <div class="govbh-search-card__title govbh-fs-h5 text--brand">البحث عن تقرير</div>
                                ...
                                <div class="row g-4">
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div
                                            ...
                                            <select class="with-search" data-placeholder-search="Search a Report Type"
                                                data-placeholder="Select Report" data-columns="1" data-select-all="yes"
                                            ...
                                            <label for="select-002">Report Type</label>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12 col-12">
                                        <div
                                            ...
                                            <label for="select-003">Year</label>
                                        </div>
                                    </div>
                                    <div class="col-12">
        ...
        <!-- List Grid Starts -->
        <div role="region" aria-label="جميع التقارير">
            <!-- Title and Sort by Starts -->
            <div class="row align-items-center g-3 mb-4">
                <div class="col-xxl-8 col-xl-7 col-lg-7 col-md-6 col-sm-12 col-12">
                    <h2 id="report-page-title" class="m-0">جميع التقارير</h2><!-- id comes from section aria-labelledby -->
                </div>
            ...
            <div class="row g-4 mb-md-5 mb-sm-4 mb-4">
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-1"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
                            <h3 id="report-title-1" class="govbh-card__title">
                                <a href="report-detail.html" aria-label="التقرير الاقتصادي لمملكة البحرين للربع الثالث 2024">التقرير الاقتصادي لمملكة البحرين للربع الثالث 2024</a>
                            </h3>
                            ...
                            <div class="govbh-card__paragraph">تقرير متعلق بالاحصائيات الاقتصادية النهائية لمملكة البحرين  للربع الثالث 2024</div>
                            <div class="govbh-card__foot">
                                <div class="govbh-btn govbh-btn--withoutline govbh-btn--medium z-1 pe-none">اقرأ التقرير <i
                                        class="ph ph-arrow-right" aria-hidden="true"></i></div>
                                <a href="../images/samplepdf.pdf" target="_blank"
                                    class="govbh-btn govbh-btn--withoutline govbh-btn--medium z-1"
                                    aria-label="تحميل: نموذج إثبات الملكية، ملف PDF، 13 ميجابايت، 8 صفحات">تحميل <i
                                        class="ph ph-download-simple" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </article>
                </div>
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-2"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
                            <h3 id="report-title-2" class="govbh-card__title">
                                <a href="report-detail.html" aria-label="التقرير الاقتصادي لمملكة البحرين للربع الاول 2023">التقرير الاقتصادي لمملكة البحرين للربع الاول 2023</a>
                            </h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                    <div><i class="ph ph-file-pdf" aria-hidden="true"></i> 13 ميجابايت، 8 صفحات</div>
                                    <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 2024</div>
                                </div>
                            <div class="govbh-card__paragraph">تقرير متعلق بالاحصائيات الاقتصادية النهائية لمملكة البحرين  للربع الثالث 2023</div>
                            <div class="govbh-card__foot">
                                <div class="govbh-btn govbh-btn--withoutline govbh-btn--medium z-1 pe-none">اقرأ التقرير <i
                                        class="ph ph-arrow-right" aria-hidden="true"></i></div>
                                <a href="../images/samplepdf.pdf" target="_blank"
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-3"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
                            <h3 id="report-title-3" class="govbh-card__title">
                                <a href="report-detail.html" aria-label="التقرير الاقتصادي لمملكة البحرين للربع الاول 2022">التقرير الاقتصادي لمملكة البحرين للربع الاول 2022</a>
                            </h3>
                            <div class="govbh-card__date govbh-card__date--year">
                                    <div><i class="ph ph-file-pdf" aria-hidden="true"></i> 13 ميجابايت، 8 صفحات</div>
                                    <div><i class="ph ph-calendar-check" aria-hidden="true"></i> 2024</div>
                                </div>
                            <div class="govbh-card__paragraph">تقرير متعلق بالاحصائيات الاقتصادية النهائية لمملكة البحرين  للربع الثالث 2022</div>
                            <div class="govbh-card__foot">
                                <div class="govbh-btn govbh-btn--withoutline govbh-btn--medium z-1 pe-none">اقرأ التقرير <i
                                        class="ph ph-arrow-right" aria-hidden="true"></i></div>
                                <a href="../images/samplepdf.pdf" target="_blank"
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-4"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-5"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                    <article role="region" aria-labelledby="report-title-6"
                        class="govbh-card govbh-card--card-file govbh-card--with-image">
                        <div class="govbh-card__image"><img src="../images/banner-003.webp"
                                alt="Data Acquisition and Processing 4" width="304" height="394" loading="lazy"></div>
                        <div class="govbh-card__head">
